...
<div class="container">
    <div class="page-breadcrumb d-flex align-items-center mb-2 border-bottom pb-2">
        <div>
            <h6 class="m-0">Create New Blog Post</h6>
        </div>
        <div class="ms-auto">
                ...
                <div class="row mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <select name="blog_category_id" id="blog_category_id" class="form-control" required>
                                ...
                                @foreach ($blogcategories as $item)
                                    <option {{ old('blog_category_id') == $item->id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-12 py-2">
                        <div class="form-group">
                            ...
                            <textarea name="description_ar" class="summernote form-control"></textarea>
                    ...
                    <div class="col-sm-12 py-2">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option {{ old('status') == "Review" ? "selected" : "" }} value="Review"> Review</option>
                    ...
                    <div class="col-sm-12  mt-3">
                        <a href="{{ route('admin.blog.index') }}" class="btn btn-warning btn-sm px-3">Cancel</a>
