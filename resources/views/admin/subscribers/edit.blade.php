                    ...
                    <div class="row mb-3">
                        <div class="col-sm-7 py-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" value="{{ $subscriber->email }}" class="form-control">
                        ...
                        <div class="col-sm-7 py-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option {{  $subscriber->status == "subscribe" ? "selected" : "" }} value="subscribe"> Subscribe</option>
                                    <option {{  $subscriber->status == "unsubscribe" ? "selected" : "" }} value="unsubscribe"> Unsubscribe</option>
                                </select>
