...
@section('content')
    <div class="container">
        ...
        <div class="page-breadcrumb d-flex align-items-center mb-2 border-bottom pb-2">
            <div>
                <h6 class="m-0">Add New Report</h6>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="card-body">
                <div class="border p-4 rounded">
                    <form action="{{ route('marketer.report.store') }}" method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <select name="customer_id" class="form-control single-select">
                                    ...
                                    @foreach ($customers as $item)
                                        <option value="{{ $item->customer_id }}"
                                            {{ old('customer_id') == $item->customer_id ? 'selected' : '' }}>{{ optional($item->customer)->name }} ({{ optional($item->customer)->phone }})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 py-2">
                                ...
                                <input name="whatsapp" value="{{ old('whatsapp') }}" class="form-control">
                            ...
                            <div class="col-12 pt-4 text-center">
                                <a href="{{ route('marketer.report.index') }}" class="btn btn-warning btn-sm px-3">Cancel</a>
